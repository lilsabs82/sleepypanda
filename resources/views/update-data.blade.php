...
<head>
    ...
    <title>Update Data - Sleepy Panda</title>
...
<body>
    <div class="dashboard-wrapper">
        ...
        <aside class="sidebar" id="sidebar">
            ...
            <nav class="sidebar-menu">
                ...
                <div class="sidebar-submenu">
                    <a href="{{ route('update-data') }}" class="sidebar-submenu-item active">Update Data</a>
        ...
        <div class="dashboard-content">
            <h1 class="page-title">Update Data User</h1>
            ...
            <div class="form-section">
                ...
                <form id="updateForm">
                    ...
                    <div class="form-group">
                        ...
                        <input type="email" class="form-input" id="emailInput" placeholder="Email user" required>
                    </div>

                    <div class="form-group">
                        <label class="form-label">Nama</label>
                        <input type="text" class="form-input" id="nameInput" placeholder="Nama user">
                    </div>

                    <div class="form-group">
                        <label class="form-label">Nomor Telepon</label>
                        <input type="text" class="form-input" id="phoneInput" placeholder="Nomor telepon">
                    </div>

                    <button type="submit" class="btn-submit" id="submitBtn">Update Data</button>
                </form>
            </div>
        </div>
    </div>
        ...
        document.addEventListener('DOMContentLoaded', async function() {
            ...
            document.getElementById('userSelect').addEventListener('change', function() {
                ...
                if (selected.value) {
                    ...
                    document.getElementById('nameInput').value = selected.dataset.name || '';
            ...
            document.getElementById('updateForm').addEventListener('submit', async function(e) {
                ...
                try {
                    ...
                    document.getElementById('alertSuccess').textContent = 'Data user berhasil diupdate';
                    document.getElementById('alertSuccess').style.display = 'block';
                    document.getElementById('alertError').style.display = 'none';
                } catch (error) {
                    document.getElementById('alertError').textContent = error.response?.data?.message || 'Gagal mengupdate data';
                    document.getElementById('alertError').style.display = 'block';
                    document.getElementById('alertSuccess').style.display = 'none';
                }
